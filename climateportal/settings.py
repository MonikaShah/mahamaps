"""
Django settings for climateportal project.
...
ROOT_URLCONF = 'climateportal.urls'
BASE_DIR = Path(__file__).resolve().parent.parent
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'climateportal.context_processors.site_settings',
            ],
        },
    },
]

WSGI_APPLICATION = 'climateportal.wsgi.application'
